...
const updateAccessAndRefereshTokens =  asyncHandler(async(req,res) => {
...
if (!avatar) {
    throw new ApiError(400, "Unable to upload avatar, please try again")}
...
const updateUserCoverAvatar = asyncHandler(async (req, res) => {
    ...
    if (!avatarLocalPath){
        throw new ApiError(400, "Cover immage file is required")
    }
